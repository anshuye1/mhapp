    ...
    render(){
        ...
        return (
            <View style={styles.filterWrap}>
                <ScrollView style={{height:height-150}} keyboardShouldPersistTaps={'never'}>
                    ...
                    <View style={styles.optionItem}>
                        ...
                        <View style={[styles.btnBox,{width:120,height:35,backgroundColor:'#1e88f5',borderRadius:8}]}>
                            <Picker
                                selectedValue={this.state.formData.city_id}
                                style={{ height: 35, width: 120,color:'#fff',padding:0}}
