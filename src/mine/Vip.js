            ...
            <View style={mine_css.modifyWrap}>
                ...
                <View style={mine_css.vipWrap}>
                    <View style={mine_css.vipGroup}>
                        <Text style={[mine_css.vipBtn,focus==1?mine_css.vipBtn1:{}]} onPress={()=>this.setState({focus:'1'})}>邀请好友</Text>
                        <Text style={[mine_css.vipBtn,focus==2?mine_css.vipBtn1:{}]} onPress={()=>this.setState({focus:'2'})}>购买会员</Text>
                    </View>
